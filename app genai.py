    ...
    try:
        ...
        open_ai_text_completion_model = OpenAIModel(
            ...
            parameters={
                ...
                "temperature": 0.2,#controls the randomness of predictions,before applying softmax function
                "max_tokens": 1500,#controls the length of generated text
            },
        )

        ielts_agent = Agent( #Instance of Agent
            role="Ielts expert",
            ...
            #specifies the style to follow while generating text
        )
        ...
        ielts_task = Task(
            ...
            agent=ielts_agent,
            instructions=f"Give {question_limit} MCQ Questions with answers", #allow the agents to guide the procedure
        )
        ...
        pipeline = LinearSyncPipeline(
            ...
            tasks=[ielts_task],#Array/list of tasks should execute in order
        )
